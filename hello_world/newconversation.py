...
class Plugin(PluginBase):
    ...
    def start(self, session):
        ...
        self.session.signals.conv_first_action.subscribe(self.on_new_conversation)
        ...
        '''do whatever your plugin will do at stop:
          ...
          you can use the sentence "pass" if you want a blank method:
              def stop(self):
                  pass
        '''
        self.session.signals.conv_first_action.unsubscribe(self.on_new_conversation)
    ...
    #this parameters are the default parameters for the conv_first_action signal
